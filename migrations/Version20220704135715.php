 ...
 */
final class Version20220704135715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exam (id INT AUTO_INCREMENT NOT NULL, code INT NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, module_id INT NOT NULL, code INT DEFAULT NULL, description LONGTEXT NOT NULL, dificulty VARCHAR(255) DEFAULT NULL, INDEX IDX_B6F7494EA76ED395 (user_id), INDEX IDX_B6F7494EAFC2B591 (module_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE niveau DROP FOREIGN KEY FK_4BDFF36BAFC2B591');
